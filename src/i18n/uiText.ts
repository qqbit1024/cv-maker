...
const deText: UIText = {
  ...
  authContinueAsGuest: "Ohne Konto fortfahren",
  authOrSeparator: "ODER",
...
const ptText: UIText = {
  ...
  authContinueAsGuest: "Continuar sem conta",
  authOrSeparator: "OU",
...
const srText: UIText = {
  ...
  authContinueAsGuest: "Настави без налога",
  authOrSeparator: "ИЛИ",
...
const frText: UIText = {
  ...
  authContinueAsGuest: "Continuer sans compte",
  authOrSeparator: "OU",
...
const plText: UIText = {
  ...
  authContinueAsGuest: "Kontynuuj jako gość",
  authOrSeparator: "LUB",
...
const ukText: UIText = {
  ...
  authContinueAsGuest: "Продовжити без акаунта",
  authOrSeparator: "АБО",
